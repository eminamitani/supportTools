...
ca ratio optimization for hexagonal crystal with relaxation of internal coordinate
...
if __name__ == '__main__':
    ...
    for caratio in ca:
        ...
        scfLine="calculation=\'relax\' \n"
        info[relaxLine]=scfLine
        
        dirname="ca-"+str(caratio)
