...
if __name__ == '__main__':
    ...
    ROOT="/home/emi/espresso/install-test/gitHub/q-e/bin"
    ...
    #experimental data for GaN
    Raman=[17.88, 66.14, 69.43, 70.57, 91.66, 92.56]
    IXSGamma=[40.79, 85.79, 90.38]
    IXSA=[28.64, 88.15]
    IXSM=[16.99, 22.81, 23.93, 29.51, 71.41]
    IXSK=[26.66, 76.12]
    ...
    label=1
    for i in Raman:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"light-red\" at "+ str(sympoints[0])+","+str(i)+"\n")
        label=label+1
    for i in IXSGamma:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[0])+","+str(i)+"\n")
        label=label+1
    for i in Raman:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"light-red\" at "+ str(sympoints[3])+","+str(i)+"\n")
        label=label+1
    for i in IXSGamma:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[3])+","+str(i)+"\n")
        label=label+1

    for i in IXSA:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[4])+","+str(i)+"\n")
        label=label+1
    for i in IXSA:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[7])+","+str(i)+"\n")
        label=label+1
        
    for i in IXSM:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[1])+","+str(i)+"\n")
        label=label+1
        
    for i in IXSK:
        gp.write("set label "+ str(label)+ " point pt 7 ps 1 lc rgb \"royalblue\" at "+ str(sympoints[2])+","+str(i)+"\n")
        label=label+1
